import dao.*;
import manip.DataReader;
import manip.MarkUpExporter;
import manip.OracleConnector;
import model.Genre;
import model.Movie;
...
*/
        try {
            ...
            MarkUpExporter.toMarkUp(Movies.getAllMovies(connection), Genres.getAllGenres(connection), Actors.getAllActors(connection), Directors.getAllDirectors(connection));
        }
        catch (Exception e) {

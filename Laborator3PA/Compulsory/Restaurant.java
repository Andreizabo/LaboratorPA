...
public class Restaurant extends Location implements Visitable, Payable, Classifiable {
    ...
    /**
     * Prints all info about this restaurant
     */
    @Override
    public void printInfo() {
        System.out.print("\n" + this.getName() + " is a restaurant that opens at " + this.getOpeningHours() + ", closes at " + this.getClosingHours() + ", has a rating of " + this.getLocationClass() + " and the food costs " + this.getPrice() + " on average.\n");
    }
}

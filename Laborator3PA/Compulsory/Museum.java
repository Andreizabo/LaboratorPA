...
public class Museum extends Location implements Visitable, Payable {
    ...
    /**
     * Prints all info about this museum
     */
    @Override
    public void printInfo() {
        System.out.print("\n" + this.getName() + "is a museum that opens at " + this.getOpeningHours() + ", closes at " + this.getClosingHours() + " and a ticket costs " + this.getPrice() + ".\n");
    }
}

...
public class Main {
    public static void main(String[] args) {
        ...
        city.getLocation(1).addMapItem(city.getLocation(0), 20.0);
        city.getLocation(3).addMapItem(city.getLocation(2), 10.0);
        city.getLocation(5).addMapItem(city.getLocation(2), 15.0);

        Trip trip = travelPlan.travel();
        trip.print("\n\n", "\n\n");
        trip = travelPlan.travelPreference();
        trip.print("\n\n", "\n\n");
    }
}
